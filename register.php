...
<main class="form-signin w-100 m-auto">
  <form action="handle_register.php" method="POST">
    ...
    <h1 class="h5 mb-3 fw-normal">Welcome sign up now and join us </h1> 
    <?php
    if (!empty($_GET["msg"])&& $_GET["msg"]=='ar') {
        ...
        <div class="alert alert-warning"
            role="alert" 
            >
            <strong>Alert Heading</strong> you are already Registered ,please  <a href="index.php">login</a>!   
...
<div class="form-floating">
      <input type="na" name="name"  class="form-control" id="floatingInput" placeholder="ahmed sultan">
